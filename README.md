...
Android 从文件管理器打开回放后，登录成功即可自动上传解析；读取失败可重试。见 [Android 回放交接](docs/android/replay-intent.md)。
...
- **认证与业务**：Keycloak（QQ + Wargaming.net ASIA / EU / NA）。
...
- [HISTORY.md](HISTORY.md) — 项目历史（关键产品、架构与工程演进）

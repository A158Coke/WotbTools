...
export const mapImages = {
  amigosville: { src: fallsCreekImg, width: 768, height: 768, coordinateBounds: WORLD_BOUNDS_300 },
  canal: { src: canalImg, width: 768, height: 768, coordinateBounds: WORLD_BOUNDS_300 },
  canyon: { src: canyonImg, width: 768, height: 768, coordinateBounds: WORLD_BOUNDS_300 },
  desert_train: { src: desertSandsImg, width: 768, height: 768, coordinateBounds: WORLD_BOUNDS_300 },
  erlenberg: { src: middleburgImg, width: 768, height: 768, coordinateBounds: WORLD_BOUNDS_300 },
  faust: { src: faustImg, width: 768, height: 768, coordinateBounds: WORLD_BOUNDS_300 },
  forgecity: { src: newBayImg, width: 768, height: 768, coordinateBounds: WORLD_BOUNDS_300 },
  fort: { src: fortDespairImg, width: 768, height: 768, coordinateBounds: WORLD_BOUNDS_300 },
  himmelsdorf: { src: himmelsdorfImg, width: 768, height: 768, coordinateBounds: WORLD_BOUNDS_300 },
  holland: { src: molendijkImg, width: 768, height: 768, coordinateBounds: WORLD_BOUNDS_300 },
  holmeisk: { src: wastelandImg, width: 768, height: 768, coordinateBounds: WORLD_BOUNDS_300 },
  idle: { src: yukonImg, width: 768, height: 768, coordinateBounds: WORLD_BOUNDS_300 },
  italy: { src: vineyardsImg, width: 768, height: 768, coordinateBounds: WORLD_BOUNDS_300 },
  karieri: { src: copperfieldImg, width: 768, height: 768, coordinateBounds: WORLD_BOUNDS_300 },
  karelia: { src: rockfieldImg, width: 768, height: 768, coordinateBounds: WORLD_BOUNDS_300 },
  lagoon: { src: lagoonImg, width: 768, height: 768, coordinateBounds: WORLD_BOUNDS_300 },
  lumber: { src: horrorstadtImg, width: 768, height: 768, coordinateBounds: WORLD_BOUNDS_300 },
  malinovka: { src: winterMalinovkaImg, width: 768, height: 768, coordinateBounds: WORLD_BOUNDS_300 },
  medvedkovo: { src: deadRailImg, width: 768, height: 768, coordinateBounds: WORLD_BOUNDS_300 },
  milbase: { src: yamatoHarborImg, width: 768, height: 768, coordinateBounds: WORLD_BOUNDS_300 },
  mountain: { src: blackGoldvilleImg, width: 768, height: 768, coordinateBounds: WORLD_BOUNDS_300 },
  neptune: { src: normandyImg, width: 768, height: 768, coordinateBounds: WORLD_BOUNDS_300 },
  pliego: { src: castillaImg, width: 768, height: 768, coordinateBounds: WORLD_BOUNDS_300 },
  plant: { src: ghostFactoryImg, width: 768, height: 768, coordinateBounds: WORLD_BOUNDS_300 },
  port: { src: portBayImg, width: 768, height: 768, coordinateBounds: WORLD_BOUNDS_300 },
  rift: { src: hellasImg, width: 768, height: 768, coordinateBounds: WORLD_BOUNDS_300 },
  rock: { src: mayanRuinsImg, width: 768, height: 768, coordinateBounds: WORLD_BOUNDS_300 },
  savanna: { src: oasisPalmsImg, width: 768, height: 768, coordinateBounds: WORLD_BOUNDS_300 },
  skit: { src: navalFrontierImg, width: 768, height: 768, coordinateBounds: WORLD_BOUNDS_300 }
}

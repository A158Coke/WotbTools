...
import showcaseBg from '../assets/home/home-showcase-bg.webp'
...
<template>
  <main class="homepage-showcase">
    <section class="showcase-hero" :style="{ '--hero-art': `url(${showcaseBg})` }">

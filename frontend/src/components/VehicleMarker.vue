...
// ---- HP HUD（docs/features/battle-playback.md §4/§5/§6/§7/§10/§11）----
...
<template>
  ...
  >
    ...
    <!-- HP HUD（docs/features/battle-playback.md §4/§5/§6/§7/§10/§11）：HP 数字 + 定宽 bar，
...
/* —— HP HUD（docs/features/battle-playback.md §4/§5/§6/§7/§10/§11）：数字 + 定宽 bar，screen-space

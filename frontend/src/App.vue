...
[data-theme="dark"] {
  ...
  --bg-card: #1a1d24;
  --bg-card2: #22262e;
  --bg-card-hover: #2a2f39;
  --bg-blue: #1a2744;
  --bg-blue-light: #1d2a3e;
  --bg-upload: #191c23;
  --bg-chip: #262b35;
  --bg-list-hover: #22262e;
  --bg-rating: #1e222c;
  --bg-t1: #1a2744;
  --bg-t2: #2d1f1f;
  --text: #e0e3e8;
  ...
  --text-code: #c8ced8;
  --border: #2d323c;
  --border-header: #2a2f39;
  --border-ghost: #333845;
  --border-dashed: #3a4050;
  --border-chip: #333845;
  --border-col: #3a4050;
  --border-light: #262b35;
  --border-heavy: #3a4050;
  --border-warn: #8a6e20;
  --border-tab-active: #2a4a7a;
  --border-rating: #2d323c;
  --accent: #5b8dd9;
  --accent-hover: #4a7cc9;
  --accent-dark: #8bb4f0;
  --accent-light: #5b8dd9;
...
.up-area { border: 2px dashed var(--border-dashed); border-radius: 10px; padding: 28px 16px; text-align: center;

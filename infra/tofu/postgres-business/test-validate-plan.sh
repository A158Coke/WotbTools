...
write_plan initial-create '{"resource_changes":[{"address":"postgresql_role.control_api","change":{"actions":["create"]}},{"address":"postgresql_database.wotb","change":{"actions":["create"]}},{"address":"postgresql_grant.control_api_database_access","change":{"actions":["create"]}}]}'
write_plan application-password-rotation '{"resource_changes":[{"address":"postgresql_database.wotb","change":{"actions":["no-op"]}},{"address":"postgresql_grant.control_api_database_access","change":{"actions":["no-op"]}},{"address":"postgresql_role.control_api","change":{"actions":["update"]}}]}'
...
write_plan clean '{"resource_changes":[{"address":"postgresql_role.control_api","change":{"actions":["no-op"]}},{"address":"postgresql_database.wotb","change":{"actions":["no-op"]}},{"address":"postgresql_grant.control_api_database_access","change":{"actions":["no-op"]}}]}'

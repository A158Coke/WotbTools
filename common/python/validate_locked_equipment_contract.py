...
def locked_definition_hashes(payload, equipment_pb):
    """Return SHA-256 for each locked equipment's complete protobuf definition."""
    raw_by_id = {}
    ...
    result = {}
    for code in LOCKED_DESCRIPTION_SHA256:
...
def validate_locked_contract(payload, details):
    """Block only description changes to partially modeled equipment."""

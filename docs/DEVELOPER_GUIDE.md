...
- `?view=vehicle-models`：隐藏 QA 页——Tier X 专属俯视车型单车型预览（仅 `wotbtools-admin`，无导航入口，深链可进；系统文档见 `docs/assets/tier-x-models/README.md`）。
...
| Tier X 车型 SVG 全局规范 | `docs/assets/tier-x-models/svg-generation-spec.md` | 生成/修复车型 SVG 时 |

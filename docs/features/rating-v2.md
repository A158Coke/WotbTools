...
最终几何使用 V2 专用的相对表现标尺（V5 已改为平均75/满分150 bounded scale）。对每轴原始值设
`q = playerRaw / batchAverageRaw`：
...
| 2026-08-30 | 相对表现标尺 | V2 使用平均=75、2×平均=100、隐藏150上限的展示几何；后续 V5 改用平均75/满分150分段映射，V2 保持不变。 |

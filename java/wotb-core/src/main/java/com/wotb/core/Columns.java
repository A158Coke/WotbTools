...
public final class Columns {
    ...
    public static final List<Column> IDENTITY = List.of(
            new Column("玩家", "nickname", 20, false, p -> p.nickname),
            new Column("战队", "clan", 10, false, p -> p.clan),

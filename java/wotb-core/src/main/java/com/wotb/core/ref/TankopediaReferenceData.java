 ...
 * replay/playback, AI, vehicle-detail and submission flows. Consumers should use this reference
 * instead of creating their own {@link Tankopedia} instance.</p>
 */
public final class TankopediaReferenceData {

    private static final Tankopedia TANKOPEDIA = Tankopedia.loadFromResources();

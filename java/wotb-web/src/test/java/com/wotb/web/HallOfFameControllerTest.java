...
class HallOfFameControllerTest {
     ...
     * GlobalExceptionHandler 统一 canonical error HTTP 400 {code: UNSUPPORTED_BATTLE_TYPE}，绝不返回 200 skipped。
     */
    @Test
    void uploadUnsupportedBattleTypeRejectsWith400() throws Exception {
        ...
        Assertions.assertThat(json).contains("\"code\":\"UNSUPPORTED_BATTLE_TYPE\"");
        verify(uploadService).upload(any());
    }
}

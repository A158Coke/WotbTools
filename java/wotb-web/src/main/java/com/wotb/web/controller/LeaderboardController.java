...
public class LeaderboardController {
    ...
    public List<LeaderboardRecordDto> topDamage(@RequestParam(defaultValue = "50") final int limit) {
        return service.topDamage(limit);
    }

    /** 指定车辆的伤害榜。 */
    @GetMapping("/tanks/{tankId}/top-damage")
    public List<LeaderboardRecordDto> topDamageByTank(@PathVariable final long tankId,

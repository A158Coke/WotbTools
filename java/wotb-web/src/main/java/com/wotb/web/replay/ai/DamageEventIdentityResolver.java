 ...
 *
 * <p>真实 {@link EntityMethodDecoder} 生成的 DamageEvent 直填账号字段恒为 null，
 * 必须沿 {@link ParticipantMappingEvent} 的 entityId→accountId 映射（复用
 * {@link TeamEntityMapper} 的确定性解析）按 {@code attackerEid/victimEid} 解析。

...
public class AdminUserDetailDto {
    ...
    public KeycloakDto getKeycloak() {
        return keycloak;
    }
    ...
    public static class KeycloakDto {
        ...
        public List<FederatedIdentityDto> getFederatedIdentities() {
            return federatedIdentities;
        }

        public void setFederatedIdentities(final List<FederatedIdentityDto> federatedIdentities) {

...
public class HundredBattleSubmission {
    ...
    public void setUserKeycloakId(final String userKeycloakId) {
    ...
    public long getGameAccountIdSnapshot() {
        return gameAccountIdSnapshot;
    }

    public void setGameAccountIdSnapshot(final long gameAccountIdSnapshot) {
        this.gameAccountIdSnapshot = gameAccountIdSnapshot;
    }
    ...
    public void setNicknameSnapshot(final String nicknameSnapshot) {
        this.nicknameSnapshot = nicknameSnapshot;
    }

    public int getClaimedAverageDamage() {
        return claimedAverageDamage;
    }

    public void setClaimedAverageDamage(final int claimedAverageDamage) {
        this.claimedAverageDamage = claimedAverageDamage;
    }

    public int getClaimedBattleCount() {
        return claimedBattleCount;
    }

    public void setClaimedBattleCount(final int claimedBattleCount) {
        this.claimedBattleCount = claimedBattleCount;
    }

    public Integer getApprovedAverageDamage() {
        return approvedAverageDamage;
    }

    public void setApprovedAverageDamage(final Integer approvedAverageDamage) {
        this.approvedAverageDamage = approvedAverageDamage;
    }

    public Integer getApprovedBattleCount() {
        return approvedBattleCount;
    }

    public void setApprovedBattleCount(final Integer approvedBattleCount) {
        this.approvedBattleCount = approvedBattleCount;
    }
    ...
    public String getProofScreenshot() {
        return proofScreenshot;
    }

    public void setProofScreenshot(final String proofScreenshot) {
        this.proofScreenshot = proofScreenshot;
    }

    public boolean isReplayParseOk() {
        return replayParseOk;
    }

    public void setReplayParseOk(final boolean replayParseOk) {
        this.replayParseOk = replayParseOk;
    }

    public boolean isReplayGameIdMatch() {
        return replayGameIdMatch;
    }

    public void setReplayGameIdMatch(final boolean replayGameIdMatch) {
        this.replayGameIdMatch = replayGameIdMatch;
    }

    public boolean isReplayVehicleMatch() {
        return replayVehicleMatch;
    }

    public void setReplayVehicleMatch(final boolean replayVehicleMatch) {
        this.replayVehicleMatch = replayVehicleMatch;
    }

    public boolean isReplayDistinctBattles() {
        return replayDistinctBattles;
    }

    public void setReplayDistinctBattles(final boolean replayDistinctBattles) {
        this.replayDistinctBattles = replayDistinctBattles;
    }
    ...
    public void setDeleteReasonText(final String deleteReasonText) {
